...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Cross-Agency Veteran Care Continuum Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Cross-Agency Veteran Care Continuum (MVA / CalVets / Behavioral Health)";
process.env.TABLE_NAME = process.env.TABLE_NAME || "cross_agency_veteran_care_continuum__mva___calvets___behavioral_health__records";
'use strict';
